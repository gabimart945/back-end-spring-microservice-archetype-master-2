package com.unir.bookings.data.utils;
    ...
    public Predicate toPredicate(Root<Product> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
        ...
        for (SearchStatement criteria : list) {
            if (criteria.getOperation().equals(SearchOperation.GREATER_THAN)) {
                ...
                predicates.add(builder.greaterThanOrEqualTo(root.get(criteria.getKey()).as(Date.class), (Date)criteria.getValue()));
            } else if (criteria.getOperation().equals(SearchOperation.DATE_LESS_THAN_EQUAL)) {
                predicates.add(builder.lessThanOrEqualTo(root.get(criteria.getKey()).as(Date.class), (Date)criteria.getValue()));
